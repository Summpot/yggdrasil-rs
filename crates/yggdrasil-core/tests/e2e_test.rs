...
async fn test_two_nodes_tcp_connection() {
    ...
    let (manager1, mut rx1) = LinkManager::new(listen_addrs1, peer_addrs1, HashMap::new(), vec![], key1, 0, config1);
    let (manager2, mut rx2) = LinkManager::new(listen_addrs2, peer_addrs2, HashMap::new(), vec![], key2, 0, config2);
...
async fn test_data_transfer_between_nodes() {
    ...
    let (manager1, mut rx1) = LinkManager::new(listen_addrs1, peer_addrs1, HashMap::new(), vec![], key1.clone(), 0, config1);
    let (manager2, mut rx2) = LinkManager::new(listen_addrs2, peer_addrs2, HashMap::new(), vec![], key2, 0, config2);
